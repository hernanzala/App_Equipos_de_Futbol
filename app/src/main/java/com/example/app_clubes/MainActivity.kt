...
class MainActivity : AppCompatActivity() {
    ...
    //esta funcion recibe un parametro puede ser SI, NO, DEPENDE (si activamos el modo oscuro lego la app abrira en modo oscuro siempre)
        delegate.applyDayNight()
        //llama al delegate y aplica el modo oscuro
    }
